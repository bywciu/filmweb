...
/**
 * Class UserFilmsWantToSee
 * @package Bywciu\Filmweb\Handlers
 */
class UserFilmsWantToSee extends BasicHandler
{
    /**
     * UserFilmsWantToSee constructor.
     */
    public function __construct()
    {
        $this->methodName = 'getUserFilmsWantToSee';
        $this->responseKeys = [
            'filmId', 'timestamp', 'level', 'type'
        ];
